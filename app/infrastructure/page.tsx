        ...
        <div className="relative z-30 w-full max-w-[1600px] mx-auto px-6 md:px-10 mt-20">
          ...
          >
            ...
            >
              ...
              erection. We provide end-to-end infrastructure solutions that
              reshape skylines and redefine structural integrity.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative z-40 -mt-20 max-w-[1600px] mx-auto px-6 md:px-10">
        ...
        >
          {disciplines.map((item, idx) => (
            <div
              key={idx}
              className="bg-[#111111]/90 backdrop-blur-xl border border-white/10 p-8 md:p-10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] group hover:-translate-y-2 transition-all duration-500 relative overflow-hidden"
            >
              {/* Hover Glow */}
          ...
          >
            ...
            <div>
              ...
              <p className="text-brand-silver/70 text-lg leading-relaxed">
                Before ground is broken, every millimeter of our projects is
                digitally constructed and stress-tested. By leveraging
                AI-assisted mapping and advanced 3D architectural engineering,
                we eliminate structural errors and optimize material efficiency.
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-brand-silver/50 text-sm">
                    Tolerance levels mapped to sub-millimeter accuracy.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-brand-silver/50 text-sm">
                    AAA-grade industrial steel and concrete sourcing.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-24 lg:py-32 bg-[#111111] border-y border-white/5 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-brand-silver/60 mb-10 max-w-xl mx-auto text-lg">
            Consult with our master architects and chief engineers to blueprint
            your next mega-structure or commercial development.
          </p>
