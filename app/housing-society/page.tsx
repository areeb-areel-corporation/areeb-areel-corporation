...
export default function HousingSocietyPage() {
  ...
  const handleContactClick = (e: React.MouseEvent) => {
    e.preventDefault(); // Stops the default link jump

    if (pathname === "/") {
      const contactSection = document.getElementById("contact"); // Make sure this matches your homepage contact ID!
      if (contactSection) {
        ...
        <div className="relative z-20 w-full max-w-[1600px] mx-auto px-6 md:px-10 flex flex-col justify-end h-full pb-32">
          ...
          >
            ...
            >
              ...
              self-sustaining residential ecosystems that blend avant-garde
              architecture with pristine natural landscapes.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          {[
            {
              ...
              desc: "Military-grade access control & 24/7 AI surveillance.",
            },
            {
              icon: TreePine,
              title: "Eco-Centric Layout",
              desc: "Over 40% dedicated green spaces and botanical parks.",
            },
            {
              icon: Droplets,
              title: "Self-Sustaining Grid",
              desc: "Independent water filtration and solar-ready infrastructure.",
            },
          ].map((item, idx) => (
            <div
              key={idx}
          ...
          >
            ...
            <div>
              ...
              <p className="text-brand-silver/70 text-lg leading-relaxed">
                Our signature villas are masterpieces of modern design.
                Featuring expansive floor plans, floor-to-ceiling smart glass,
                and private infinity pools. Every home is oriented to maximize
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-white/10">
              ...
              <div>
                ...
                <span className="text-white font-semibold">
                  Contemporary Spanish & Minimalist
                </span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <div>
              ...
              <p className="text-brand-silver/70 text-lg leading-relaxed">
                A thriving economic nucleus integrated directly into the master
                plan. The Boulevard features high-rise corporate suites, premium
                retail outlets, and fine dining—ensuring residents have access
                to global commodities without leaving the gates.
              </p>
            </div>
      ...
      <section className="relative py-32 bg-[#111111] border-t border-white/5 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-brand-silver/60 mb-12 max-w-2xl mx-auto text-lg leading-relaxed">
            Phase 1 inventory is strictly limited. Connect with our real estate
            advisory board to view the interactive master plan and discuss
