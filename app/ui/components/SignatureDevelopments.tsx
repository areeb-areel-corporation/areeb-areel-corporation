...
const developments = [
  {
    ...
    description: 'Ultra-luxury residential sectors featuring state-of-the-art security, green spaces, and modern architecture.',
  },
  {
    id: '02',
    ...
    description: 'High-capacity, AAA-standard petroleum stations strategically developed across key logistical routes.',
  },
  {
    id: '03',
    ...
    src: '/images/mart.png',
    description: 'Premium retail experiences built directly into our energy hubs for unmatched consumer convenience.',
  },
];
    ...
    <section className="w-full bg-brand-black py-20 lg:py-32">
      <div className="max-w-[1600px] mx-auto px-6 md:px-10 mb-12 lg:mb-20">
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter">
          Signature <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F1E5AC]">Developments.</span>
        </h2>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-10">
        <div className="flex flex-col lg:flex-row h-auto lg:h-[700px] gap-4 lg:gap-2">
          {developments.map((project, index) => {
            ...
            // Logic to calculate width:
            // 1. Mobile: always 100%
            // 2. Desktop (Hovered): 60%
            // 3. Desktop (Hovered Other): 20%
            // 4. Desktop (No Hover): 33.33%
            const getWidth = () => {
              ...
              >
                <Image
                  ...
                  className={`object-cover transition-all duration-[800ms] ease-out ${
                    isHovered || isMobile ? 'scale-105 grayscale-0' : 'scale-100 grayscale opacity-60'
                  }`}
                />
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 lg:p-10 z-20 flex flex-col justify-end h-full">
                  ...
                  <div 
                    className={`overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                      isHovered || isMobile ? 'max-h-[200px] opacity-100 mt-2' : 'max-h-0 opacity-0 mt-0'
                    }`}
                  >
                    ...
                    <button className="flex items-center gap-3 group/btn text-xs font-bold uppercase tracking-widest text-[#D4AF37] hover:text-white transition-colors duration-300">
                      Explore Division
                      <div className="w-8 h-8 rounded-full border border-[#D4AF37]/50 flex items-center justify-center group-hover/btn:bg-[#D4AF37] group-hover/btn:border-[#D4AF37] transition-all duration-300">
                        <ArrowUpRight className="w-4 h-4 text-[#D4AF37] group-hover/btn:text-brand-black transition-colors" />
                      </div>
                    </button>
                  </div>
                </div>
