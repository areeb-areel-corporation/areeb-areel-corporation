...
export default function AIChatModal() {
  ...
  // Prevent scroll jitter during streaming
  useEffect(() => {
  ...
  return (
    <>
      {/* ── EXPANDING ACTION BUTTONS (WhatsApp & AI) ── */}
      <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-40 flex flex-col items-end gap-3 sm:gap-4">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="group flex items-center rounded-full border border-[#25D366]/30 bg-[#0a0a0a]/90 backdrop-blur-md p-1.5 sm:p-2 shadow-[0_0_20px_rgba(37,211,102,0.15)] transition-all duration-500 hover:border-[#25D366]/60 hover:shadow-[0_0_30px_rgba(37,211,102,0.3)]"
          aria-label="Contact us on WhatsApp"
        >
          <span className="relative flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white shadow-[0_0_15px_rgba(37,211,102,0.4)] z-10">
            {/* Custom WhatsApp SVG */}
          ...
          <span className="overflow-hidden whitespace-nowrap text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#25D366] transition-all duration-500 max-w-0 opacity-0 group-hover:max-w-[150px] group-hover:opacity-100 group-hover:pl-3 group-hover:pr-2">
            WhatsApp
          </span>
        </motion.a>
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.95 }}
          className="group flex items-center rounded-full border border-[#D4AF37]/30 bg-[#0a0a0a]/90 backdrop-blur-md p-1.5 sm:p-2 shadow-[0_0_30px_rgba(212,175,55,0.15)] transition-all duration-500 hover:border-[#D4AF37]/60 hover:shadow-[0_0_45px_rgba(212,175,55,0.3)]"
          aria-label="Open AI assistant"
        >
          <span className="relative flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F1E5AC] text-[#050505] shadow-[0_0_15px_rgba(212,175,55,0.4)] z-10">
            <Bot className="h-5 w-5 sm:h-6 sm:w-6" />
            {/* Ping Indicator */}
            <span className="absolute -top-0.5 -right-0.5 flex h-2.5 w-2.5 sm:h-3 sm:w-3">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-75"></span>
              <span className="relative inline-flex rounded-full h-full w-full bg-green-500 border border-[#D4AF37]"></span>
            </span>
          </span>
          <span className="overflow-hidden whitespace-nowrap text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#D4AF37] transition-all duration-500 max-w-0 opacity-0 group-hover:max-w-[150px] group-hover:opacity-100 group-hover:pl-3 group-hover:pr-2">
            AI Assistant
          </span>
        </motion.button>
